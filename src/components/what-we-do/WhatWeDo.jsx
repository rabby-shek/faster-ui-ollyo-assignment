          ...
          <div className="row g-4">
            ...
            <div className="col-lg-4" data-aos="fade-right" data-aos-delay="400">
              <div class="card h-100 py-2">
                <div class="card-body">
                  <h5 class="card-title w-card-icon-container">
                    <TvIcon className="w-icon" />
                  </h5>
                  <h6 class="card-subtitle mb-2 w-card-title">
                    Responsive Design
                  </h6>
                  <p class="card-text w-text">
                    From concept to launch, we create stunning, user-centric
                ...
                <div class="card-body">
                  <div className="row h-100 g-3">
                    <div className="col-lg-6">
                      <h5 class="card-title w-card-icon-container">
                        <VectorSmallIcon className="w-icon" />
                      </h5>
                      <h6 class="card-subtitle mb-2 w-card-title">Webflow</h6>
                      <p class="card-text w-text">
                        From concept to launch, we create stunning, user-centric
                        websites that elevate your brand and engage your
                        audience.
                      </p>
                    </div>
                    <div className="col-lg-6">
            ...
            <div className="col-lg-4" data-aos="fade-right" data-aos-delay="600">
              <div class="card h-100 py-2">
                <div class="card-body">
                  <h5 class="card-title w-card-icon-container">
